...
(function (factory) {
    ...
    var Tokenfield = function (element, options) {
        ...
        this.$element
            ...
            .prop("tabindex", -1);
        this.$wrapper = $('<div class="tokenfield form-control" id="tokenInputDiv" />');
        ...
        this.$input = $(
            ...
            '" class="token-input form-control phone-numbers" autocomplete="off" />'
        )
    ...
    Tokenfield.prototype = {
        ...
        createToken: function (attrs, triggerChange) {
            ...
            attrs.label =
                attrs.label && attrs.label.length ? $.trim(attrs.label) : attrs.value;
            if (
                !attrs.value.length ||
                !attrs.label.length ||
            ...
            $token
                ...
                .on("dblclick", function (e) {
                    if (_self._disabled || _self._readonly || !_self.options.allowEditing)
                        return false;
                    _self.edit($token);
                });
        ...
        keydown: function (e) {
                ...
                case 13:
                    if (
                        ...
                        this.$input
                            ...
                            .menu.element.find("li:has(a.ui-state-focus), li.ui-state-focus")
                            .length
                    )
                        break;
                    if (
            ...
            function upDown(direction) {
                ...
                if (_self.$input.is(document.activeElement)) {
                    if (_self.$input.val().length > 0) return;
                    var $token = _self.$input.hasClass("tt-input")
                        ? _self.$input.parent()[direction + "All"](".token:first")
            ...
            switch (e.keyCode) {
                case 8:
                    if (this.$input.is(document.activeElement)) {
                        if (
                            this.$input.val().length ||
                            (this.lastInputValue.length && this.lastKeyDown === 8)
                        )
                            break;
                ...
                var $firstActiveToken = this.$wrapper.find(".active:first"),
                    deactivate =
                        $firstActiveToken && this.$firstActiveToken
                            ? $firstActiveToken.index() < this.$firstActiveToken.index()
                            : false;
                ...
                var $lastActiveToken = this.$wrapper.find(".active:last"),
                    deactivate =
                        $lastActiveToken && this.$firstActiveToken
                            ? $lastActiveToken.index() > this.$firstActiveToken.index()
                            : false;
        ...
        remove: function (e, direction) {
            ...
            if (e.type !== "click") {
                ...
                this[direction]();
                if (direction === "prev")
                    var firstToken = $token.first().prevAll(".token:first").length === 0;
            }
            var options = {
